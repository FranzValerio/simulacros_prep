...
tipo_eleccion = str(input("Indique el tipo de elección: 'PRES', 'SEN' o 'DIP_FED': ")).upper()

folder_path = 'C:/Users/franz/Desktop/simulacros_prep/BDD_Fed' # Laptop

inicio_intervalo = pd.to_datetime('2024-06-02 20:00')

fin_intervalo = pd.to_datetime('2024-06-02 21:30')
...
titulo_elecciones = {'PRES': 'Presidencia',
                     'SEN': 'Senadurías',
                     'DIP_FED': 'Diputaciones'}
...
def generar_titulo(tipo):
    ...
    primera = "Instituto Nacional Electoral - Elecciones Federales "

    segunda = "(2 de junio del 2024) - "
...
def tiempos_finales(df, tipo_eleccion):
    ...
    Args:
        ...
        tipo_eleccion (str): Tipo de elección ('PRES', 'DIP_LOC', 'AYUN') para la cual se realizará el análisis.
